 ...
 * @author Sergio Ramos
 */
public class Selecao5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Cartesianas p/ Cilindricas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selecao5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
