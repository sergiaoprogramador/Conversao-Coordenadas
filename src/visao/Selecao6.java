 ...
 * @author Sergio Ramos
 */
public class Selecao6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Cilindricas p/ Cartesianas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selecao6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
